...
export default function SuccessStories() {
  return (
    <section className="relative overflow-hidden bg-[#F1F5F9] py-24 lg:py-32" data-testid="success-stories-section">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <Reveal className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold leading-[1.1] tracking-tight text-slate-900 sm:text-4xl lg:text-[52px]">
            Real Journeys. <span className="gradient-text-career">Real Transformations.</span>
          </h2>
