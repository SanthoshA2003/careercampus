...
export default function ProblemSection() {
  return (
    <section id="problem" className="relative py-24 lg:py-32" data-testid="problem-section">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <Reveal className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold leading-[1.1] tracking-tight text-slate-900 sm:text-4xl lg:text-[52px]">
            The Education System Was Designed To Help You <span className="text-slate-400">Pass Exams.</span>{" "}
            <span className="gradient-text-career">Not Build Careers.</span>
          </h2>
